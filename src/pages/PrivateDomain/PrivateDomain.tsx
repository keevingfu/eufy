...
const PrivateDomain: React.FC<PrivateDomainProps> = () => {
  ...
  const handleSearchWithThinking = (query: string) => {
    ...
    const mockThinkingSteps: ThinkingStep[] = [
      { step: 1, thought: "Analyzing query content, determining relevant private domain metrics" },
      { step: 2, thought: "Retrieving engagement data from owned channels" },
      { step: 3, thought: "Processing conversion metrics and identifying key user segments" },
      { step: 4, thought: "Generating visualization charts and extracting key insights" },
      { step: 5, thought: "Formulating action recommendations based on private domain analysis" }
    ];
